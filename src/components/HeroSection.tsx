...
const HeroSection = () => {
  ...
  return (
    ...
    >
      <div className="absolute inset-0 -z-10 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-rgba(0, 0, 0, 0.12)-600/10 via-rgba(0, 0, 0, 0.12)-800/5 to-transparent"></div>
      
      <div className="container mx-auto px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          <div className="max-w-2xl">
            <div className="mb-6 inline-flex items-center rounded-full bg-rgba(0, 0, 0, 0.12)-50 px-3 py-1 text-sm animate-on-scroll animate-fade-in">
              <span className="font-medium text-rgba(0, 0, 0, 0.12)-600">New platform</span>
              <span className="ml-2 text-rgba(0, 0, 0, 0.12)-800/70">Launching Fall 2025</span>
            </div>
            ...
            <div className="mt-4 flex flex-wrap gap-4 animate-on-scroll animate-fade-in stagger-2">
              <Button size="lg" className="animated-button bg-rgba(0, 0, 0, 0.12)-600 hover:bg-rgba(0, 0, 0, 0.12)-700 px-8 shadow-md">
                Get Started
              ...
              <Button 
                variant="outline" 
                size="lg" 
                className="border-rgba(0, 0, 0, 0.12)-400/20 text-rgba(0, 0, 0, 0.12)-800 hover:bg-rgba(0, 0, 0, 0.12)-50 px-8"
            ...
            <div className="mt-6 flex items-center space-x-4 animate-on-scroll animate-fade-in stagger-3">
              <div className="flex -space-x-2">
                <div className="w-8 h-8 rounded-full bg-rgba(0, 0, 0, 0.12)-500 border-2 border-white flex items-center justify-center">
                  <BookOpen className="w-4 h-4 text-white" />
                </div>
                <div className="w-8 h-8 rounded-full bg-rgba(0, 0, 0, 0.12)-600 border-2 border-white flex items-center justify-center">
                  <ClipboardList className="w-4 h-4 text-white" />
                </div>
                <div className="w-8 h-8 rounded-full bg-rgba(0, 0, 0, 0.12)-700 border-2 border-white flex items-center justify-center">
          ...
          >
            <div className="absolute inset-0 -z-10 bg-gradient-to-tr from-rgba(0, 0, 0, 0.12)-500/20 to-transparent rounded-2xl blur-3xl"></div>
            <div className="relative bg-white/80 backdrop-blur-sm p-2 rounded-2xl shadow-elevated overflow-hidden">
              ...
              <div className="absolute -bottom-6 -right-6 transform rotate-6">
                <div className="glass-card p-3 rounded-lg flex items-center space-x-3 shadow-elevated">
                  <div className="bg-rgba(0, 0, 0, 0.12)-600 p-2 rounded-full text-white">
              ...
              <div className="absolute top-10 -left-12 transform -rotate-6">
                <div className="glass-card p-3 rounded-lg shadow-elevated animate-pulse-glow">
                  ...
                  <div className="mt-1 text-sm font-semibold text-rgba(0, 0, 0, 0.12)-600">Automated</div>
                </div>
              </div>
            </div>
          </div>
