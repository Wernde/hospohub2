...
const NotFound = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#e5e5e5] p-6 text-center">
      {/* Logo */}
      <div className="mb-0">
        <img
          src="/hospohub2/public/Images/Logo-HospoHub4.png"
          alt="HospoHub Logo"
          className="logo-breathing h-40 w-auto drop-shadow-2xl"y
        />
      </div>
      ...
      {/* Return Home Button */}
      <Button size="lg" className="animated-button bg-[#737373] text-white hover:bg-gray-400/2">
